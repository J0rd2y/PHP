...
//Model-Controller Area.  The PHP processing code goes in this area. 
	...
	$inFirstName = $_POST[""];		//Get the value entered in the first name field
	$inLastName = $_POST[""];		//Get the value entered in the last name field
	$inSchool = $_POST[""];			//Get the value entered in the school field
